			...
			<div className={styles.dashboardPanel}>
				...
				<div className={styles.dashboardGrid}>
					<DashboardCard
						...
						icon={<ClipboardCheck className={styles.cardIcon} />}
						onClick={() => navigate("/evaluation")}
						onHoverEnter={() => setHoveredSection("Evaluation Test")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						title="Journal"
						description="Record your thoughts"
						icon={<Book className={styles.cardIcon} />}
						onClick={() => navigate("/journal")}
						onHoverEnter={() => setHoveredSection("Journal")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						...
						onHoverEnter={() => setHoveredSection("Community Chat")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						title="Peaceful Music"
						description="Listen to calming sounds"
						icon={<Music className={styles.cardIcon} />}
						onClick={() => navigate("/music")}
						onHoverEnter={() => setHoveredSection("Peaceful Music")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						title="Mindful Assistant"
						description="Get AI support"
						icon={<MessageSquareHeart className={styles.cardIcon} />}
						onClick={() => navigate("/assistant")}
						onHoverEnter={() => setHoveredSection("Mindful Assistant")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						title="Encyclopedia"
						...
						onHoverEnter={() => setHoveredSection("Encyclopedia")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						...
						onHoverEnter={() => setHoveredSection("Daily Activities")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						title="Image Analyzer"
						description="Analyze your images"
						icon={<Image className={styles.cardIcon} />}
						onClick={() => navigate("/image-analyzer")}
						onHoverEnter={() => setHoveredSection("Image Analyzer")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
					<DashboardCard
						title="Sleep Cycle Analysis"
						description="Analysing your sleep for better mental health"
						icon={<Moon className={styles.cardIcon} />}
						onClick={() => navigate("/SleepCycleSection")}
						onHoverEnter={() => setHoveredSection("SleepCycleSection")}
						onHoverLeave={() => setHoveredSection(null)}
					/>
				</div>
			</div>
				...
				<div className={styles.dashboardWidgets}>
					<div className={styles.widgetCard}>
						<div className={styles.widgetHeader}>
							<Smile /> Select your current mood{" "}
						</div>
						...
						<p className={styles.widgetNote}>
							Today's Mood: <strong>{mood || "Not set"}</strong>
						</p>
						{moodHistory.length > 0 && (
							<p className={styles.moodHistory}>
								Last Moods:{" "}
								{moodHistory.map((m, i) => (
									<span key={i} className={styles.historyEmoji}>
										{m}
									</span>
								))}
							</p>
					...
					<div className={styles.widgetCard}>
						<div className={styles.widgetHeader}>
							<Lightbulb /> Mental Health Tip
						</div>
						<p className={styles.widgetTip}>{tip}</p>
						<button onClick={refreshTip} className={styles.tipRefreshButton}>
							Refresh Tip
						</button>
					</div>
				</div>
